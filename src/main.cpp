...
class Test_Simple3D:public Activity{
private:
    Texture m_tex;
    Surface m_sur;
    SDL_Surface* m_sur3D;
public:
    void OnInit(){
        m_sur.Load("Title/StarSky43.png");
        m_sur3D = SDL_CreateRGBSurface(0,1024,576,32,0x00FF0000,0x0000FF00,0x000000FF,0x00000000);
...
public:
    void OnInit(){
        m_sur = SDL_CreateRGBSurface(0,800,600,32,0xFF0000,0x00FF00,0x0000FF,0x00000000);
    	device_init(&device, 800, 600, m_sur->pixels);
